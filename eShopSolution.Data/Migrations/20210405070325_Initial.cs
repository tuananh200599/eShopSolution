        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 4, 5, 14, 3, 23, 443, DateTimeKind.Local).AddTicks(7779)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("ca5ab7c5-6a78-4080-866e-bd41f9c07fd1"), "4b7f5b53-c6f1-446a-b611-621fe0fe5a01", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a6e1e441-93c5-4046-85ff-a3e009f3cf91"), 0, "6f243d6d-1d46-4d33-b733-56194480cee2", new DateTime(1999, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "anh453138@gmail.com", true, "Anh", "Nguyen", false, null, "anh453138@gmail.com", "admin", "AQAAAAEAACcQAAAAEGVKq0y/xDWboP/wdAKFuQHrN28cb6ppFzjoWGjMX46wXh1zLmzeJc0ZmplW0WJIAA==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 4, 5, 14, 3, 23, 488, DateTimeKind.Local).AddTicks(8138), 100000m, 200000m, null, 0, 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Điện thoại Iphone", "dien-thoai-Iphone", "Sản phẩm điện thoại Iphone", "Sản phẩm điện thoại Iphone" },
                    { 3, 2, "vi", "Điện thoại Samsung", "dien-thoai-samsung", "Sản phẩm điện thoại Samsung", "Sản phẩm điện thoại Samsung" },
                    { 2, 1, "en", "Iphone Phone", "iphone-phone", "The iphone phone products ", "The iphone phone products" },
                    { 4, 2, "en", "Samsung Phone", "samsung-phone", "The samsung phone products", "The samsung phone products" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sản phẩm điện thoại Iphone 12", "Sản phẩm điện thoại Iphone 12", "vi", "Điện thoại Iphone 12", 1, "dien-thoai-Iphone-12", "Sản phẩm điện thoại Iphone 12", "Sản phẩm điện thoại Iphone 12" },
                    { 2, "The iphone 12 phone products", "The iphone 12 phone products", "en", "Iphone 12 Phone", 1, "iphone12-phone", "The iphone 12 phone products", "The iphone 12 phone products" }
                });
